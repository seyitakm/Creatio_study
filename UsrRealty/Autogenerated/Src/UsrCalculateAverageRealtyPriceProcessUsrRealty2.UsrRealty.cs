namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAverageRealtyPriceProcessUsrRealty2MethodsWrapper

	/// <exclude/>
	public class UsrCalculateAverageRealtyPriceProcessUsrRealty2MethodsWrapper : ProcessModel
	{

		public UsrCalculateAverageRealtyPriceProcessUsrRealty2MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var cityNameColumn = esq.AddColumn("UsrCity.Name");
